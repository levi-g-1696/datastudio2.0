...
export default class MonitorListComp extends Component {
  ...
  getNew = mon => {
    ...
    this.setState({ monLists: this.state.monLists.concat(newMonList) })
    this.setState({ userControl: "read" })
    // 
 ...
 onEditMonList = mon => {
    ...
    modMonList= modMonList.concat(newDestination)
...
//=====================  contentV2 =====================================================================================================
    const contentV2 = () => {
      let str1 = this.randomInteger()
         ...
         if (this.state.userControl == "create") {return  (
       <>  
      < MonListFormV3   MonNamesString= {"mon1"}  />
       </>  )
        // return <>
        ...
        return <>
           ...
           < MonListFormV3   MonNamesString= {"monWS,monPREC10,monT,monRH"}  />
        </>
      }
      else if (this.state.userControl == "read") {
