...
export default class DestinationCompV3c extends Component {
    constructor() {
        super();
        this.state = {
            userControl: "read",
    ...
    //----------------------
    testCall() { alert("test call 55 sucess") }
    //--------------------------------------------
    handleClick = control => {
    ...
    content = () => {
        ...
        if (this.state.userControl == "create") {
            ...
            return <DataTable destinations={this.state.destinations} getSelectedID={this.testCall()}  />;
        }
        else if (this.state.userControl == "remove") {
            return <> <DataTable /></>;
        }
    ...
    getSelectedID = f => {
        ...
        //  })
        console.log("destcompClass. sel id= ")
    }
